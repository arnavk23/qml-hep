...
\begin{itemize}
    \item \texttt{circuit1.png}: Five-qubit circuit diagram
    \item \texttt{circuit2.png}: SWAP test circuit diagram
    \item \texttt{swap\_test\_result.png}: SWAP test ancilla measurement bar chart
\end{itemize}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../task1/circuit1.png}
    \caption{Task 1: Five-qubit circuit diagram.}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../task1/circuit2.png}
    \caption{Task 1: SWAP test circuit diagram.}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../task1/swap_test_result.png}
    \caption{Task 1: SWAP test ancilla measurement probabilities.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{../task2/figures/roc_dgcnn.png}
    \caption{Task 2: ROC curve for DGCNN.}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{../task2/figures/roc_gat.png}
    \caption{Task 2: ROC curve for GAT.}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{../task2/figures/roc_comparison.png}
    \caption{Task 2: ROC comparison (DGCNN vs GAT).}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{../task2/figures/training_history.png}
    \caption{Task 2: Training and validation loss/AUC curves.}
\end{figure}
...
Metric & Value \\
\midrule
Accuracy & (see qgan.py output) \\
AUC & (see qgan.py output) \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{../task4/qgan_training_losses.png}
    \caption{Task 4: QGAN training loss curves.}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{../task4/qgan_roc_curve.png}
    \caption{Task 4: QGAN ROC curve.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{../task5/qgnn_circuit.png}
    \caption{Task 5: QGNN circuit diagram (PNG).}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{../task5/qgnn_circuit.svg}
    \caption{Task 5: QGNN circuit diagram (SVG).}
\end{figure}
